Logging:
- Intro: It's not just for ASP.NET Core!
  - Azure Functions, Console apps, Libraries that may or may not run on Core.
- Types and Terminology
  - Mixed up factory and provider a lot.
- Hosting.
  - Create factory. Add providers. Inject/pass factory. Components create loggers.
...
https://github.com/dotnet/corefx/issues/8931#issuecomment-337354565

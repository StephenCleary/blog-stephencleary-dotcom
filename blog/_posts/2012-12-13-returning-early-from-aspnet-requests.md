...
tags: ["async", "Nito.AsyncEx", "ASP.NET"]
---
...
{% highlight csharp %}BackgroundTaskManager.Run(() =>
{
    Thread.Sleep(20000);
});
...
{% highlight csharp %}BackgroundTaskManager.Run(async () =>
{

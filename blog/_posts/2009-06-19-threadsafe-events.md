...
{% highlight csharp %}public event MyEventHandler MyEvent;
{% endhighlight %}
...
{% highlight csharp %}private MyEventHandler __MyEvent;
...
{% highlight csharp %}if (this.MyEvent != null)
{
...
{% highlight csharp %}MyEventHandler myEvent = this.MyEvent;
if (myEvent != null)
{
    myEvent(this, args);
}
...
{% highlight csharp %}private object myEventLock = new object();
...
{% highlight csharp %}private MyEventHandler myEvent;
public event MyEventHandler MyEvent
{
    add
    {

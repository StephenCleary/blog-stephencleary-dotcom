...
If the instance you're creating is a _shared resource_, then you can use [asynchronous lazy initialization](/2012/08/asynchronous-lazy-initialization.html) to create your shared instance:

...
**Update, 2015-02-02:** The .NET team has [released a post](https://devblogs.microsoft.com/pfxteam/new-task-apis-in-net-4-6/) describing the `RunContinuationsAsynchronously` option. As the name implies, it does in fact run the continuation asynchronously.
</div>
